...
@if (session('error')) setTimeout(() => showErrorNotification('{{ session('error') }}'), 100) @endif">
    <div x-show="showSuccess" x-transition
        class="fixed top-20 right-6 bg-green-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 flex items-center gap-2"
        style="display: none;">
    ...
    <div x-show="showError" x-transition
        class="fixed top-20 right-6 bg-red-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 flex items-center gap-2"
        style="display: none;">
